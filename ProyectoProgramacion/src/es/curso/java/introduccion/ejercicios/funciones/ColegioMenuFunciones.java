...
//					}
    ...
    public static void estudiante (String nombre,String dni ,double nota) {
	...
	//case 1: //Insertar alumnos
    	...
    	int estudiante = Utilidades.pideDatoNumerico("En que aula quieres insertarlo");
		String [][] colegio = new String[estudiante][];
		dimensionarColegio(colegio);
